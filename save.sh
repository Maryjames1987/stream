...
Saves STREAM test results to CSV files, Google BigQuery, MySQL or PostgreSQL. 
Triad gnuplot PNG images may also be saved to S3, Google Cloud Storage or Azure 
...
--db_prefix                 If the --db argument is set, this argument 
                            ...
                            table. Default table name is 'stream' with no 
                            prefix
...
--store_prefix              If the --store argument is set, this argument 
                            ...
                            values may be included:
                              ...
                              {benchmark}     => benchmark name (stream)
...
# save results in ~/stream-testing
...
# save results to BigQuery and artifacts (Triad PNG images) to S3
