...
print_msg(sprintf('Starting STREAM test'), $verbose, __FILE__, __LINE__);
$status = $test->test() ? 0 : 1;
print_msg(sprintf('Exiting STREAM test with status code %d', $status), $verbose, __FILE__, __LINE__);
